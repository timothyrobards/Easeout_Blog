        ...
        <div class="item xs-block xs-full-height">
          ...
          <no-ssr>
            ...
            <ul class="list-unstyled xs-flex xs-flex-align-center">
              ...
              <li class="xs-inline-block xs-mr1" v-if="this.$store.state.theCategory.includes('HTML')"><div class="tag tag-html">
                <nuxt-link :to="`/category/${this.$store.state.theCategory.toLowerCase()}/`" class="tag__link text-white">{{this.$store.state.theCategory}}</nuxt-link>
              </div></li> 
          ...
          <div class="xs-py3 post-content text-gray-lighter">
            ...
            <p>While you're here, you can browse through my blogs where I post freelancing tips, code tutorials, design inspiration, useful tools & resources, and much more! You can also <a href="https://easeout.eo.page/news">join the newsletter</a>, or find me on <a href="https://twitter.com/easeoutco">X</p>
