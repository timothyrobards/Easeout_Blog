        ...
        <div class="book-grid">
          ...
          <div class="div7">
              <div class="center">
                ...
                <br /><p>Get instant access to the <strong>Complete Guide to Freelancing</strong> and unlock the secrets to success! Freelancing has opened up a world of opportunities for me, and I’m certain it can do the same for you.</p>
                <br /><br>
              <div class="center">  
              ...
              <p>That's up to you! Equipping yourself with knowledge is one thing. But to truly succeed you need determination! If you stay focused and work hard, you'll see the results!</p><br>
...
export default {
   ...
   async asyncData({ params, app, payload, route, store }) {
    await store.commit("SET_TITLE", "The Complete Guide to Freelancing");
    await store.commit("SET_CRUMB", 'Freelance');
  },
     transition (to, from) {
    if (!from) return 'fade'
  ...
  data() {
    ...
    head() {
    return {
      title: "The Complete Guide to Freelancing | " + this.$store.state.siteInfo.sitename,
      meta: [{
        hid: 'description',
        name: 'description',
        content: 'The Complete Freelance Mastery Toolkit.'
      }],
    };
  },
  data() {
...
.div3 { grid-area: 2 / 1 / 3 / 3; width: 60%;}
.div4 { grid-area: 3 / 1 / 4 / 3; width: 60%;}
.div5 { grid-area: 4 / 1 / 5 / 2; }
.div6 { grid-area: 4 / 2 / 5 / 3; }
.div7 { grid-area: 5 / 1 / 6 / 3; width: 60%;}
...
@media only screen and (max-width: 800px) {
  .book-grid {
    ...
    .div3 { grid-area: 3 / 1 / 4 / 2; width: 90%;}
    .div4 { grid-area: 4 / 1 / 5 / 2; width: 90%;}
    .div5 { grid-area: 5 / 1 / 6 / 2; }
    .div6 { grid-area: 6 / 1 / 7 / 2; }
    .div7 { grid-area: 7 / 1 / 8 / 2; width: 90%;}
