<template>
  <nav ref="navBar" id="navbar" class="sm-border-bottom">
    ...
    <div class="topbar">
      ...
      <p>👉&nbsp;Get the
      <nuxt-link to="/freelance" class="promo-link" exact>Complete Guide to Freelancing</nuxt-link> now! 🎉🎉</p>
    </div>
    ...
    <div class="r">
      ...
      <div class="c-3 xs-text-left">
        <div>
          ...
          <nuxt-link class="sitename" to="/" exact><img class="easeout-logo" src="~/assets/EASEOUT_LOGO_NEW_BLACK.svg" alt="Easeout Logo"/></nuxt-link>
        </div>
      </div>
